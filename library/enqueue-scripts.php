...
if (!function_exists('FoundationPress_scripts')) :
  function FoundationPress_scripts() {
    ...
    //wp_register_script( 'modernizr', get_template_directory_uri() . 'assets/js/bin/vendor/modernizr.js', array(), '1.0.0', false );
    wp_register_script( 'jquery', get_template_directory_uri() . '/assets/js/bin/jquery.min.js', array(), '2.1.3', false );


    // register scripts - footer
    wp_register_script( 'materialize', get_template_directory_uri() . '/assets/js/bin/materialize.js', array('jquery'), '1.0.0', true );

    wp_register_script( 'obasemgluten', get_template_directory_uri() . '/assets/js/bin/obasemgluten.js', array('jquery'), '1.0.0', true );
	...
	*/
    ...
    wp_enqueue_script('obasemgluten');
